...
## 2. Your repository
Your work lives in one repo named `<grant>-<workstream>` (e.g. `linkage-damage-detection`). It was created from our [`project-template`](https://github.com/cumlg/project-template), so it already has the folder structure, conventions, and a `CLAUDE.md`.
...
Your issues appear on the group board, **Workstreams — Qilin Li**. Set the **Grant** field and drag your issue into **This week**.
